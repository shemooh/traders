...
export default function HeroSection() {
  ...
  return (
    <section id="home" className="bg-white dark:bg-gray-900 py-20 transition-colors duration-200">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button size="lg" variant="outline" className="dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-800">
                Free Delivery
              </Button>
            </div>
          </div>
